...
本仓库收录与 AgileBuilder 产品生态相关的 AI Agent Skills，用于增强 AI 在项目创建、模板交付和项目改造场景中的能力。
...
- 使用 `agilebuilder-template-delivery` 前，需要在当前 Agent 环境中启用 AgileBuilder MCP。
...
| [`project-skeletonization`](skills/project-skeletonization) | 将完整业务项目改造为可复用的基础项目骨架，保留通用能力并删除业务功能。 | “把这个项目改成 skeleton”、“去掉业务功能保留基础框架” |

## 贡献和维护

本仓库以英文文档为主。`SKILL.md` 使用英文，`README.md` 为英文主文档，`README.zh-CN.md` 为中文文档。修改 Skill 时请同步维护双语 README。详见 [CONTRIBUTING.md](CONTRIBUTING.md)。
